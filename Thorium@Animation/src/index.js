 ...
 * @returns
 */
export const Magic = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
 ...
 * @returns
 */
export const TwisterInDown = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const TwisterInUp = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenDownLeft = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenDownRight = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenUpLeft = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenUpRight = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenDownLeftReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenUpLeftReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenUpRightReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenDownLeftOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenDownRightOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenUpLeftOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const OpenUpRightOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveDown = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveUp = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveLeft = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveRight = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveDownReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveUpReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveLeftReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const PerspectiveRightReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const RotateDown = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const RotateLeft = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const RotateRight = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SlideDownReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SlideUpReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SlideLeftReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SlideRightReturn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const TinRightOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const TinLeftOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const TinDownOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const TinRightIn = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const BombRightOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const BombLeftOut = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const BoingOutDown = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceOutUp = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceOutRight = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceOutDown = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceOutLeft = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceInRight = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceInDown = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
 ...
 * @returns
 */
export const SpaceInLeft = (target) => {
    if (target.classList.contains('magictime'))
        return;
    else {
        target.classList.add('magictime');
