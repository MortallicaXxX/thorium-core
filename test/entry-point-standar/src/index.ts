import Thorium , { Connector , DesignSystem , DOM , ThoriumController , PaternArea } from '../../../dist';
        ...
        DOM.render<HTMLDivElement>({
            ...
            childrens : [
                ThoriumInput({
                    ...
                    proto : {
                        onmousedown : (event) => {
                            ThoriumAnimation.RotateDown(event.target as HTMLElement);
                        },
                    }
                }),
                ThoriumInput({
                    ...
                    proto : {
                        onmousedown : (event) => {
                            ThoriumAnimation.BoingInUp(event.target as HTMLElement);
                        },
                    }
                })
            ]
